...
function inputPaginationValidatorForBlogs(sentListOfAllowedFields) {
    ...
    return [
        (0, express_validator_1.query)('sortBy')
            ...
            .withMessage((value) => { (0, error_handling_helpers_1.customErrorInQueryMessage)(`Invalid sortBy field. Must be one of the following: ${listOfAllowedFields.join(', ')}`, `${value}`); }),
